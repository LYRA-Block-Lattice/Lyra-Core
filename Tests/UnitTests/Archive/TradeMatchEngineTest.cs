...
namespace Lyra.Node.Test
{
    public partial class Authorizer_Tests
    {
        ...
        public void GetActiveTradeOrderList_11()
        {
            ...
            var result = tradeMatchEngine.GetActiveTradeOrders(LyraGlobal.OFFICIALTICKERCODE, null, TradeOrderListTypes.All);
        ...
        public void GetActiveTradeOrderList_12()
        {
            ...
            var result = tradeMatchEngine.GetActiveTradeOrders("Custom.USD", LyraGlobal.OFFICIALTICKERCODE, TradeOrderListTypes.All);
        ...
        public void GetActiveTradeOrderList_13()
        {
            ...
            var result = tradeMatchEngine.GetActiveTradeOrders(LyraGlobal.OFFICIALTICKERCODE, "USD", TradeOrderListTypes.All);
