...
namespace Lyra.Node.Test
{
    ...
    public partial class Authorizer_Tests
    {
        ...
        static string PrivateKey3;
        static string AccountId3;
        ...
        // Account2:
        OpenWithReceiveTransferBlock _OpenAccount2Block;
        ...
        const string connectionString = "mongodb+srv://lyra:iTbuBxv59M24027507kuyt@cluster0-qfihj.azure.mongodb.net/test?retryWrites=true&w=majority";
        ...
        public static void ClassInitialize(TestContext testContext)
        {
            ...
            PrivateKey3 = "2gU4pYDRP7ZRkLfoebJ5nwG4YQCwfyGydgYPkKC2Uny6uPepra";
            AccountId3 = Signatures.GetAccountIdFromPrivateKey(PrivateKey3);

            NodeGlobalParameters.Network_Id = NETWORK_ID;

            serviceDatabase = new LiteAccountDatabase();
            //serviceDatabase = new MongoServiceAccountDatabase(connectionString, "lyra", ServiceAccount.SERVICE_ACCOUNT_NAME, NETWORK_ID);
            ...
            //accountCollection = new MongoAccountCollection(connectionString, "lyra", NETWORK_ID);
        }
        ...
        public void FirstGenesisBlock()
        {
            ...
            //            Assert.AreEqual(1800000000 * Math.Pow(10, 2), _FirstGenesisBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
            Assert.AreEqual(1800000000, _FirstGenesisBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
        }
        ...
        public void USDToken_1()
        {
            ...
            //Assert.AreEqual((1800000000 - 100) * Math.Pow(10, 2), _USDTokenBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
            //Assert.AreEqual(100000 * Math.Pow(10, USD_PRECISION), _USDTokenBlock.Balances["USD"]);
            Assert.AreEqual((1800000000 - 100), _USDTokenBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
        ...
        public void SendTransfer()
        {
            ...
            //Assert.AreEqual((1800000000 - 100 - 50000 - 1) * Math.Pow(10, 2), _SendTransferBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
            //Assert.AreEqual(100000 * Math.Pow(10, USD_PRECISION), _SendTransferBlock.Balances["USD"]);
            Assert.AreEqual((1800000000 - 100 - 50000 - 1), _SendTransferBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
        ...
        public void OpenSecondAccount()
        {
            ...
            //Assert.AreEqual(50000 * Math.Pow(10, 2), _OpenAccountBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
            Assert.AreEqual(50000, _OpenAccount2Block.Balances[LyraGlobal.OFFICIALTICKERCODE]);
        }

        [TestMethod]
        public void OpenThirdAccount_DUPLICATE()
        {
            CreateFirstGenesisBlock();
            CreateUSDToken(false);
            ProcessSendGRFT();
            ...
            var result = ProcessOpenThirdAccount_DUPLICATE();
            Assert.AreEqual(APIResultCodes.InvalidDestinationAccountId, result);
        }

        [TestMethod]
        public void ReceiveGRFTonSecondAccount_DUPLICATE()
        {
            CreateFirstGenesisBlock();
            CreateUSDToken(false);
            ProcessSendGRFT();
            ProcessReceiveGRFT();
            var result = ProcessReceiveGRFT_DUPLICATE();
            Assert.AreEqual(APIResultCodes.DuplicateReceiveBlock, result);
        ...
        public void SellTradeOrderBlock() // from account 1
        {
            ...
            //Assert.AreEqual(1799949898.80 * Math.Pow(10, 2), _SellOrderBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
            //Assert.AreEqual(99900 * Math.Pow(10, USD_PRECISION), _SellOrderBlock.Balances["USD"]);
            Assert.AreEqual(1799949898.80m, _SellOrderBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
        ...
        public void BuyTradeOrderBlock() // 
        {
            ...
            //            Assert.AreEqual((50000 - 100 * 5) * Math.Pow(10, 2), _BuyOrderBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
            Assert.AreEqual((50000 - 100 * 5), _BuyOrderBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
        }
        ...
        public void Trade() // 
        {
            ...
            //Assert.AreEqual(49500 * Math.Pow(10, 2), _TradeBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
            Assert.AreEqual(49500, _TradeBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
        }
        ...
        public void RPC_Test_LookForNewTrade_SellTokensSpecified() // 
        {
            ...
            var rpc = new RPCMethods(serviceAccount, accountCollection, tradeMatchEngine);
            var result = rpc.LookForNewTrade(AccountId1, null, LyraGlobal.OFFICIALTICKERCODE, SignAPICall(PrivateKey1)).Result;
        ...
        public void RPC_Test_LookForNewTrade_BothTokensSpecified() // 
        {
            ...
            var rpc = new RPCMethods(serviceAccount, accountCollection, tradeMatchEngine);
            var result = rpc.LookForNewTrade(AccountId1, "Custom.USD", LyraGlobal.OFFICIALTICKERCODE, SignAPICall(PrivateKey1)).Result;
        ...
        [TestMethod]
        public void RPC_Test_LookForNewTransfer_FOUND() // 
        {
            CreateFirstGenesisBlock();
            CreateUSDToken(false);
            ProcessSendGRFT();
            ...
            var rpc = new RPCMethods(serviceAccount, accountCollection, tradeMatchEngine);
            var result = rpc.LookForNewTransfer(AccountId2, SignAPICall(PrivateKey2)).Result;

            Assert.AreEqual(APIResultCodes.Success, result.ResultCode);
        }

        [TestMethod]
        public void RPC_Test_LookForNewTransfer_NOT_FOUND() // 
        {
            CreateFirstGenesisBlock();
            CreateUSDToken(false);
            ProcessSendGRFT();
            ...
            Assert.AreEqual(APIResultCodes.NoNewTransferFound, result.ResultCode);
        }
        ...
        public void RPC_Test_LookForNewTrade_WrongBuyTokensSpecified() // 
        {
            ...
            var rpc = new RPCMethods(serviceAccount, accountCollection, tradeMatchEngine);
            var result = rpc.LookForNewTrade(AccountId1, LyraGlobal.OFFICIALTICKERCODE, null, SignAPICall(PrivateKey1)).Result;
        ...
        public void ExecuteTrade_1() // 
        {
            ...
            //Assert.AreEqual(1799949898.80 * Math.Pow(10, 2), _ExecuteTradeOrderBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
            //Assert.AreEqual(99900 * Math.Pow(10, USD_PRECISION), _ExecuteTradeOrderBlock.Balances["USD"]);
            Assert.AreEqual(1799949898.80m, _ExecuteTradeOrderBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
        ...
        public void ReceiveTradeAcc1() // 
        {
            ...
            //Assert.AreEqual(1799950398.80 * Math.Pow(10, 2), _ReceiveTransferBlockAcc1.Balances[LyraGlobal.OFFICIALTICKERCODE]);
            //Assert.AreEqual(99900 * Math.Pow(10, USD_PRECISION), _ReceiveTransferBlockAcc1.Balances["USD"]);
            Assert.AreEqual(1799950398.80m, _ReceiveTransferBlockAcc1.Balances[LyraGlobal.OFFICIALTICKERCODE]);
        ...
        public void ReceiveTradeAcc2() // 
        {
            ...
            //Assert.AreEqual(49500 * Math.Pow(10, 2), _ReceiveTransferBlockAcc2.Balances[LyraGlobal.OFFICIALTICKERCODE]);
            //Assert.AreEqual(100 * Math.Pow(10, USD_PRECISION), _ReceiveTransferBlockAcc2.Balances["USD"]);
            Assert.AreEqual(49500, _ReceiveTransferBlockAcc2.Balances[LyraGlobal.OFFICIALTICKERCODE]);
        ...
        ExecuteTradeOrderBlock CreateExecuteTradeBlock(TransactionBlock previousBlock, TradeBlock trade, TradeOrderBlock order, NonFungibleToken discount_token = null)
        {
            _ExecuteTradeOrderBlock = new ExecuteTradeOrderBlock()
            {
                ...
                //BuyTokenCode = LyraGlobal.OFFICIALTICKERCODE,
            ...
            _ExecuteTradeOrderBlock.Balances.Add(LyraGlobal.OFFICIALTICKERCODE, previousBlock.Balances[LyraGlobal.OFFICIALTICKERCODE]);
            ...
            _ExecuteTradeOrderBlock.FeeCode = LyraGlobal.OFFICIALTICKERCODE;
        ...
        APIResultCodes ProcessTrade()
        {
            ...
            var block = CreateTradeBlock(_OpenAccount2Block);
        ...
        TradeBlock CreateTradeBlock(TransactionBlock previousBlock)
        {
            ...
            if (_TradeBlock.SellTokenCode == LyraGlobal.OFFICIALTICKERCODE)
        ...
        {
            var authorizer = new TradeOrderAuthorizer(serviceAccount, accountCollection, tradeMatchEngine);
            _BuyOrderBlock = CreateBuyOrderBlock(_OpenAccount2Block);
        ...
        {
            _OpenAccount2Block = CreateNewAccountBlock();
            var authorizer = new NewAccountAuthorizer(serviceAccount, accountCollection);
            return authorizer.Authorize<OpenWithReceiveTransferBlock>(ref _OpenAccount2Block);
        }

        APIResultCodes ProcessReceiveGRFT_DUPLICATE()
        {
            var block = CreateDuplicateReceiveBlock();
            var authorizer = new ReceiveTransferAuthorizer(serviceAccount, accountCollection);
            return authorizer.Authorize<ReceiveTransferBlock>(ref block);
        }

        APIResultCodes ProcessOpenThirdAccount_DUPLICATE()
        {
            var block = CreateNewAccountBlock_DUPLICATE();
            var authorizer = new NewAccountAuthorizer(serviceAccount, accountCollection);
        ...
        OpenWithReceiveTransferBlock CreateNewAccountBlock_DUPLICATE()
        {
            var openReceiveBlock = new OpenWithReceiveTransferBlock
            {
                AccountType = AccountTypes.Standard,
        ...
        ReceiveTransferBlock CreateDuplicateReceiveBlock()
        {
        ...
        TradeOrderBlock CreateSellOrderBlock(TransactionBlock previousBlock)
        {
            ...
            tradeBlock.Balances.Add(LyraGlobal.OFFICIALTICKERCODE, previousBlock.Balances[LyraGlobal.OFFICIALTICKERCODE] - trading_fee);
