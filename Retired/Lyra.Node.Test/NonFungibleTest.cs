...
namespace Lyra.Node.Test
{
    public partial class Authorizer_Tests
    {
        ...
        public void CreateNonFungibleToken()
        {
            ...
            var previous_GRFT_balance = _FirstGenesisBlock.Balances[TokenGenesisBlock.LYRA_TICKER_CODE];
            var new_GRFT_balance = _DiscountTokenBlock.Balances[TokenGenesisBlock.LYRA_TICKER_CODE];

            Assert.AreEqual(0, previous_GRFT_balance - (new_GRFT_balance + serviceAccount.GetLastServiceBlock().TokenGenerationFee));

            Assert.AreEqual(1799999900, _DiscountTokenBlock.Balances[TokenGenesisBlock.LYRA_TICKER_CODE]);
        ...
        public void SendNonFungibleToken_1()
        {
            ...
            var previous_GRFT_balance = _DiscountTokenBlock.Balances[TokenGenesisBlock.LYRA_TICKER_CODE];
            var new_GRFT_balance = _SendTransferBlock.Balances[TokenGenesisBlock.LYRA_TICKER_CODE];
            ...
            Assert.AreEqual(1799999899, _SendTransferBlock.Balances[TokenGenesisBlock.LYRA_TICKER_CODE]);
        ...
        public void SendNonFungibleToken_4_WRONG_TOKEN_CODE()
        {
            ...
            var disount_token = new NonFungibleToken();
            disount_token.Denomination = 50;
            disount_token.TokenCode = TokenGenesisBlock.LYRA_TICKER_CODE;
            //disount_token.OriginHash = "some unique random string";
            disount_token.RedemptionCode = "12345";
