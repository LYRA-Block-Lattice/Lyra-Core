...
namespace Lyra.Core.Blocks
{
    ...
    public class BrokerAccountRecv : ReceiveTransferBlock, IOpeningBlock
    {
    ...
    [BsonIgnoreExtraElements]
    public class BrokerAccountSend : SendTransferBlock, IOpeningBlock
    {
        public AccountTypes AccountType { get; set; }
        public string OwnerAccountId { get; set; }
        public string RelatedTx { get; set; }
    ...
    [BsonIgnoreExtraElements]
    public class ProfitingBlock : BrokerAccountRecv
    {
    ...
    [BsonIgnoreExtraElements]
    public class StakingBlock : BrokerAccountRecv
    {
    ...
    [BsonIgnoreExtraElements]
    public class UnStakingBlock : BrokerAccountSend
    {
        public string Voting { get; set; }
