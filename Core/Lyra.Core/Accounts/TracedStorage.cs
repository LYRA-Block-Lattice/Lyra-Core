...
namespace Lyra.Core.Accounts
{
    public class TracedStorage : IAccountCollectionAsync
    {
        ...
        public async Task<List<TokenGenesisBlock>> FindTokensForAccountAsync(string accountId) => await StopWatcher.TrackAsync(() => _store.FindTokensForAccountAsync(accountId), StopWatcher.GetCurrentMethod());//_store.FindTokensAsync(keyword);
