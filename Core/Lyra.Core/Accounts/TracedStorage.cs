...
namespace Lyra.Core.Accounts
{
    public class TracedStorage : IAccountCollectionAsync
    {
        ...
        public async Task<List<TransactionBlock>> FindDaosAsync(string keyword) => await StopWatcher.TrackAsync(() => _store.FindDaosAsync(keyword), StopWatcher.GetCurrentMethod());//_store.FindDaosAsync(keyword);
