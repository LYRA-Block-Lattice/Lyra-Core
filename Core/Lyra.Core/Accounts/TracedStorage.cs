...
namespace Lyra.Core.Accounts
{
    public class TracedStorage : IAccountCollectionAsync
    {
        ...
        public async Task<List<Block>> GetBlocksInConsByHeightAsync(long height) => await StopWatcher.TrackAsync(() => _store.GetBlocksInConsByHeightAsync(height), StopWatcher.GetCurrentMethod());
