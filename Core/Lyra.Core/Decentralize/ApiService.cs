    ...
    public class ApiService : INodeTransactionAPI//, IBlockConsensus
    {
        ...
        private async Task<(APIResultCodes result, TransactionBlock block)> ProcessFee(string source, decimal fee)
        {
            ...
            if(latestBlock == null)
            {
                ...
                receiveBlock.InitializeBlock(null, NodeService.Instance.PosWallet.PrivateKey, AccountId: NodeService.Instance.PosWallet.AccountId);
            ...
            else
            {
                ...
                receiveBlock.InitializeBlock(latestBlock, NodeService.Instance.PosWallet.PrivateKey, AccountId: NodeService.Instance.PosWallet.AccountId);
