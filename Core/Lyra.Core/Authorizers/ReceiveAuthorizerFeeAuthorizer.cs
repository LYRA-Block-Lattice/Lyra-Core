...
{
    public class ReceiveAuthorizerFeeAuthorizer : BaseAuthorizer
    {
        public ReceiveAuthorizerFeeAuthorizer()
        {
        }
        ...
        {
            if (!(tblock is ReceiveAuthorizerFeeBlock))
                return APIResultCodes.InvalidBlockType;

            var block = tblock as ReceiveAuthorizerFeeBlock;
